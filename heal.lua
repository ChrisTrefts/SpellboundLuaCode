...
function clicked(clicked_object, playerColorClicked)
    printToAll('Gao used Necrotic Rejuvenation, please select who you would like to use it on!' , playerColorClicked)
    self.removeButton(0)
...
function hg(clicked_object, playerColorClicked)
    ...
    if (maxHP == health) then
        printToAll("Gao your already at full HP why on earth would you need to heal yourself; Necrotic Rejuvenation has not been used")
        self.removeButton(5)
        self.removeButton(4)
        self.removeButton(3)
        self.removeButton(2)
        ...
        if rando == 1 then
            printToAll('While attempting to perform Necrotic Rejuvenation, with a NAT 1 ' .. Player[playerColorClicked].steam_name .. " has gotten a CRIT FAIL resulting in no health replenished!", playerColorClicked)
            printToAll('Necrotic Rejuvenation will be off cooldown on turn ' .. turn + 3)
        else
            ...
            total = rando + dam
            printToAll('On a D' .. totalDice .. ' ' .. Player[playerColorClicked].steam_name .. ' rolled a ' .. rando .. ' to heal himself for a total of ' .. total .. ' hit points!', playerColorClicked)
            newHp = health + total
...
function ha(clicked_object, playerColorClicked)
    ...
    if (maxHP == health) then
        printToAll("Gao, Arthur\'s HP is already full, why on earth would you need to heal him; Necrotic Rejuvenation has not been used")
        self.removeButton(5)
        self.removeButton(4)
        self.removeButton(3)
        self.removeButton(2)
        ...
        if rando == 1 then
            ...
            total = rando + dam
            printToAll('On a D' .. totalDice .. ' ' .. Player[playerColorClicked].steam_name .. ' rolled a ' .. rando .. ' to heal Arthur for a total of ' .. total .. ' hit points!', playerColorClicked)
            newHp = health + total
...
function he(clicked_object, playerColorClicked)
    ...
    if (maxHP == health) then
        printToAll("Gao, Enji\'s HP is already full, why on earth would you need to heal him; Necrotic Rejuvenation has not been used")
        self.removeButton(5)
        self.removeButton(4)
        self.removeButton(3)
        self.removeButton(2)
        ...
        if rando == 1 then
            ...
            total = rando + dam
            printToAll('On a D' .. totalDice .. ' ' .. Player[playerColorClicked].steam_name .. ' rolled a ' .. rando .. ' to heal Enji for a total of ' .. total .. ' hit points!', playerColorClicked)
            newHp = health + total
...
function hf(clicked_object, playerColorClicked)
    ...
    if (maxHP == health) then
        printToAll("Gao, Feather\'s HP is already full, why on earth would you need to heal him; Necrotic Rejuvenation has not been used")
        self.removeButton(5)
        self.removeButton(4)
        self.removeButton(3)
        self.removeButton(2)
...
function hn(clicked_object, playerColorClicked)
    ...
    if (maxHP == health) then
        printToAll("Gao, Noah\'s HP is already full, why on earth would you need to heal him; Necrotic Rejuvenation has not been used")
        self.removeButton(5)
        self.removeButton(4)
        self.removeButton(3)
        self.removeButton(2)
        ...
        if rando == 1 then
            ...
            total = rando + dam
            printToAll('On a D' .. totalDice .. ' ' .. Player[playerColorClicked].steam_name .. ' rolled a ' .. rando .. ' to heal Noah for a total of ' .. total .. ' hit points!', playerColorClicked)
            newHp = health + total
...
function ho(clicked_object, playerColorClicked)
    ...
    if rando == 1 then
        ...
        total = rando + dam
        printToAll('On a D' .. totalDice .. ' ' .. Player[playerColorClicked].steam_name .. ' rolled a ' .. rando .. ' to heal a non player entity for a total of ' .. total .. ' hit points!', playerColorClicked)
        printToAll('Necrotic Rejuvenation will be off cooldown on turn ' .. turn + 3)
    end
...
function check(clicked_object, playerColorClicked)
    printToAll('Gotta wait for Necrotic Rejuvenation to be off cooldown', playerColorClicked)
end

function GoBack()
    checker = 999
    printToAll('Manually resetting cooldown of Necrotic Rejuvenation')
    self.removeButton(1)
    self.removeButton(0)
    self.createButton(ab)
end
...
function resetCD()
    ...
    if turn >= tonumber(checker) then
        checker = 999
        printToAll('Necrotic Rejuvenation is off cooldown')
        self.removeButton(1)
        self.removeButton(0)
        self.createButton(ab)
    end
